package com.developer.bshapp.classes
...
class Slider  @JvmOverloads constructor(
    ...
    private var viewPagerAdapter: vpAdapter? = null
    ...
    fun setImageList(imageList: List<SlideModel>) {
        viewPagerAdapter = vpAdapter( context, imageList, cornerRadius, errorImage, placeholder, titleBackground, textAlign)
    ...
    fun setImageList(imageList: List<SlideModel>, scaleType: ScaleTypes? = null) {
        viewPagerAdapter = vpAdapter( context, imageList, cornerRadius, errorImage, placeholder, titleBackground, scaleType, textAlign)
        viewPager!!.adapter = viewPagerAdapter
        imageCount = imageList.size
        if (imageList.isNotEmpty()){
            setupDots(imageList.size)
